  ...
  return (
    <Layout title="Privacy Policy">
      <div className={styles.container}>
        ...
        <p className={styles.p}>Last updated: May 03, 2020</p>
        ...
        <h1 className={styles.h1}>Interpretation and Definitions</h1>
        ...
        <h2>Definitions</h2>
        <p className={styles.p}>For the purposes of this Privacy Policy:</p>
        <ul>
          <li>
            <p className={styles.p}>
          ...
          <li>
            <p className={styles.p}>
              ...
              in this Agreement) refers to Swift International LLC, 1 Cupertino,
              CA 95014.
            </p>
          </li>
          <li>
          ...
          <li>
            <p className={styles.p}>
              ...
              <a
                ...
                target="_blank"
              >
                https://swiftsecuritylogistics.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h1 className={styles.h1}>Collecting and Using Your Personal Data</h1>
        ...
        <ul>
          <li>
            <p className={styles.p}>First name and last name</p>
          </li>
          <li>
            <p className={styles.p}>
          ...
          <li>
            <p className={styles.p}>Usage Data</p>
          </li>
        </ul>
        <h3>Usage Data</h3>
        <p className={styles.p}>
        ...
        <ul>
          <li>
            ...
            <p className={styles.p}>Type: Session Cookies</p>
            <p className={styles.p}>Administered by: Us</p>
            <p className={styles.p}>
          ...
          <li>
            ...
            <p className={styles.p}>Type: Persistent Cookies</p>
            <p className={styles.p}>Administered by: Us</p>
            <p className={styles.p}>
        ...
        <h1 className={styles.h1}>Links to Other Websites</h1>
        <p className={styles.p}>
        ...
        <ul>
          <li>
            <p className={styles.p}>
              By email: help@swiftsecuritylogistics.com
            </p>
          </li>
          <li>
            <p className={styles.p}>
              ...
              <a
                href="swiftsecuritylogistics.com/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                swiftsecuritylogistics.com/contact-us
              </a>
            </p>
          </li>
        </ul>
